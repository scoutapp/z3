...
@pytest.mark.parametrize(
    "pair, expected", list(HAPPY_PATH.values()), ids=list(HAPPY_PATH.keys())
)
...
@pytest.mark.parametrize(
    "pair, err_msg", list(ERRORS.values()), ids=list(ERRORS.keys())
)
...
@pytest.mark.parametrize(
    "pair, expected", list(PULL_HAPPY_PATH.values()), ids=list(PULL_HAPPY_PATH.keys())
)
...
@pytest.mark.parametrize(
    "pair, expected", list(PUSH_HAPPY_PATH.values()), ids=list(PUSH_HAPPY_PATH.keys())
)
